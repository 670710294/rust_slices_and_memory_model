...
| 3 | `นายสิรวิชญ์ เชี่ยวชาญ` | `670610296` | `@[username]` | Rust vs Other Language + PPL |
...
`Slices & Memory Model`  
`ตัว Slices คือการแบ่งย่อยจากตัวเซตข้อมูลหลัก ไม่ว่าจะเป็น List,Array หรือ String`  
...
| `Member 1` |  
| Git/Vsc Agent | สำหรับเรียนรู้วิธีการใช้งานระหว่าง Github กับ Vsc โดยใช้ GUI | ก็สามารถ Push Pull Commit Clone ได้อย่างปลอดภัยและใส่ไฟล์ได้ตามที่เราต้องการ |
